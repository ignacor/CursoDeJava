...
capucha.style.alignContent = 'center'

//h1//
titulo23.style.color = '#d20c0c'
//nav//
nave.style.marginTop = '15px'
...
introcont.style.backgroundPosition = 'center top'
introcont.style.width = '100%'
introcont.style.height = '875px'
introcont.id = 'intro'
...
titredes.style.marginBottom = '50px'
