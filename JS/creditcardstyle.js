...
titulo.innerText = 'Valorant Boosting - Realizar Pagos'
...
btnpagar.style.marginTop = '25%'
btnpagar.style.marginLeft = '25%'
...
//Dolar Hoy //
const divdolar = d.createElement('div')
divdolar.style.backgroundColor = '#222222'
divdolar.style.width = '70%'
divdolar.style.height = '30%'
divdolar.style.marginLeft = '15%'
divdolar.style.marginTop = '10%'
divdolar.style.borderRadius = '15px'
formudatospers.append(divdolar)

const dolartit = d.createElement ('h2')
dolartit.innerText = 'Dolar Hoy!'
dolartit.style.textAlign = 'center'
dolartit.style.color = 'd20c0c'
divdolar.append(dolartit)

const dolarvalor = d.createElement('div') 
dolarvalor.innerHTML = ''
dolarvalor.id = 'dolarvalor'
divdolar.append(dolarvalor)
